 ...
 *  - se path porta fuori dall'abero, inserisce come figlio della foglia da
 * cui è usciti dallalbero un nuovo nodo che contiene e. Restituisce:
 ...
 * dell'ARB in un ordine tale che, se gli elementi sono tutti distinti, allora
